<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="id_pegawai" name="id_pegawai" placeholder="NIK" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
		...
		$sql_simpan1 = "INSERT INTO tb_ppnpn (id_pegawai,id_pengguna) VALUES (
            '".$_POST['id_pegawai']."',
			'".$_POST['id_pengguna']."'
			)";

			$sql_simpan2 = "INSERT INTO tb_pendidikan (id_pegawai) VALUES (
				'".$_POST['id_pegawai']."'
				)";

				$sql_simpan3 = "INSERT INTO tb_keluarga (id_pegawai) VALUES (
					'".$_POST['id_pegawai']."'
					)";
		...
		$query_simpan3 = mysqli_query($koneksi, $sql_simpan3);
