		...
		<div class="table-responsive">
			...
			<table id="" class="table table-bordered table-striped">
				...
				?>
					...
					<tr>
						...
						<td>
						<a href="?page=del-pendidikan&kode=<?php echo $data['nama_sekolah']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
			...
			<div class="card-footer">
					...
					<a href="./report/cetak-pendidikan.php?nip=<?php echo $data_cek['nip']; ?>" target=" _blank"
					 ...
					 <a href="?page=add-pendidikan" target=" _blank"
					 title="Tambah Data Pendidikan" class="btn btn-primary">Tambah Data</a>
					 <a href="?page=view-diklat&kode=<?php echo $data_cek['nip']; ?>" class="btn btn-warning">Selanjutnya</a>
				</div>
		</div>
	</div>
	<!-- /.card-body -->