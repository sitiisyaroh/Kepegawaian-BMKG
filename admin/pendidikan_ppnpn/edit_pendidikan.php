	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="number" class="form-control" id="id_pegawai" name="id_pegawai" value="<?php echo $data_cek['id_pegawai']; ?>"
					 readonly/>
				</div>
			</div>
                        ...
                        <div class="form-group row">
                          <label class="col-sm-3  col-form-label">Tanggal Upload</label>
                            ...
                            <input type="date" class="form-control"
                                   placeholder="Enter your Tanggal Upload" name="tgl_up" value="<?php echo $data_cek['tgl_up']; ?>">
                            </div>
                        </div>
