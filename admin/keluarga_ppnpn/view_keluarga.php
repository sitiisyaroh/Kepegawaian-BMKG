	...
	<div class="card-body">
		<div class="table-responsive">
					...
					<tr>
						...
						<a href="?page=del-keluarga&kode=<?php echo $data['NIK']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')"
							 title="Hapus" class="btn btn-danger btn-sm">
								...
								<a href="?page=edit-keluarga-ppnpn&kode=<?php echo $data['NIK']; ?>" title="Ubah" class="btn btn-success btn-sm">
			...
			<div class="card-footer">
					...
					<a href="?page=add-keluarga-ppnpn" target=" _blank"
					 title="Tambah Data Keluarga" class="btn btn-primary">Tambah Data</a>
					 <a href="./report/cetak-keluarga.php?id_pegawai=<?php echo $data_cek['id_pegawai']; ?>" target=" _blank"
