...
<?php
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT * FROM tb_ppnpn INNER JOIN tb_keluarga 
		WHERE tb_keluarga.id_pegawai='".$_GET['kode']."'";
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit']))
                        {
                          ...
                          // If the ‘pdf_file’ field has an attachment
                            ...
                            $insertquery =
                            "INSERT INTO tb_keluarga(id_pegawai,NIK,hubungan, nama,jenis_kelamin,tempat_lahir,tanggal_lahir,tanggal_nikah,pekerjaan,keterangan,filename) VALUES('$id_pegawai','$name','$hubungan','$nama','$jenis_kelamin','$tempat_lahir','$tanggal_lahir','$tanggal_nikah','$pekerjaan','$keterangan','$file_name')";
...
<div class="form-group row">
  <label class="col-sm-3  col-form-label">NIK</label>
    <div class="col-sm-9">
     <input type="number" class="form-control" id="id_pegawai" name="id_pegawai" value="<?php echo $data_cek['id_pegawai']?>" readonly>
  </div>
</div>

<div class="form-group row">
  <label class="col-sm-3  col-form-label">NIK Anggota Keluarga</label>
  <div class="col-sm-9">
...
<div class="form-group row">
  ...
  <div class="col-sm-9">
    <input type="text" class="form-control"
           placeholder="Tanggal Nikah" name="tanggal_nikah" required>
  </div>
</div>
...
<div class="card-footer">
    <input type="submit"
          ...
          <a href="?page=view-keluarga-ppnpn&kode=<?php echo $data_cek['id_pegawai']; ?>" class="btn btn-warning">Kembali</a>
</div>
</div>
                </form>
            </div>           
